...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'fish.sqlite3'),                      # Or path to database file if using sqlite3.
...
if not DEBUG:
    DATABASES['default'] =  dj_database_url.config(default=os.environ.get('HEROKU_POSTGRESQL_BLUE_URL'))
...
STATICFILES_DIRS = (
    ...
    os.path.join(BASE_DIR, 'static-dev' if DEBUG else 'static'),
...
SECRET_KEY = '(5r1a4^m!z333xxgc1#ga!abf91*rt^fzxw*uf3l9$ysc@^u87'
